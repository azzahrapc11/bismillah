        ...
        <div class="row">
            ...
            <div class="credits ml-auto">
                <span class="copyright">
                    ...
                    </script>{{ __(', made with ') }}<i class="fa fa-heart heart"></i>{{ __(' by ') }}<a class="@if(Auth::guest()) text-white @endif" href="https://www.creative-tim.com" target="_blank">{{ __('Azzahra Pramata Callista') }}</a>
                </span>
            </div>
        </div>
    </div>
